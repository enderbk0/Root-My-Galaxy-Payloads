...
make TARGET=a36xq-A366BXXSACZF1 ANDROID_NDK_HOME=/path/to/android-ndk
...
The SM-A366B CZF1 port analysis (offsets, slide data, BTF layouts) is in
[`docs/SM-A366B-A366BXXSACZF1.md`](docs/SM-A366B-A366BXXSACZF1.md).
